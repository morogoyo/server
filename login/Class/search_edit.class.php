...
function form(){
	...
	echo ' </form>';
	echo ' </div>';	
	echo ' <p><h3>Always use Member number when Editing</h3></p>'; 
...
function edit_form(){
		...
		echo '
								  ...
								  <!--<div class="col-xs-1 col-md-1" ></div>-->
				   	               <div class="panel panel-danger col-xs-6 col-md-3">
...
function add_noble_form(){
		...
		echo '
						           ...
						           <div class="row">
				   	               ...
				   	               <div class="panel panel-danger col-xs-12 col-md-12">
		          ...
		          while ($row = $result->fetch_object()){
			             ...
			             if ($row->$select != null){
								   ...
								   echo ucfirst($row->F_name)." ".ucfirst($row->M_name)." ".ucfirst($row->L_name); 
									...
									echo '<td>';
									echo  $row->address." </br> ". $row->city." ". $row->state." ". $row->zip;
									echo'</td>';
